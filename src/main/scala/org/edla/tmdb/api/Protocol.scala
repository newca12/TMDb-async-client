...
object Protocol extends DefaultJsonProtocol {
  ...
  case class AuthenticateResult(
      expires_at: String, request_token: String, success: Boolean)
  case class ProductionCountry(iso_3166_1: String, name: String)
  case class Release(
      iso_3166_1: String, certification: String, release_date: String)
  ...
  case class Collection(poster_path: Option[String],
                        id: Long,
                        name: String,
                        backdrop_path: Option[String])
  case class Movie(runtime: Option[Long],
                   status: String,
                   backdrop_path: Option[String],
  ...
  case class Result(original_title: String,
                    ...
                    backdrop_path: Option[String])
  case class Results(
      total_results: Int, results: List[Result], page: Int, total_pages: Int)
