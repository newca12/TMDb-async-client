...
class TmdbException(message: String = null, cause: Throwable = null, val code: Long)
    extends RuntimeException(message, cause)

class InvalidApiKeyException(message: String = null, cause: Throwable = null, code: Long)
    extends TmdbException(message, cause, code)

object TmdbException {
  def apply(message: String = null, cause: Throwable = null, code: Long): TmdbException =
